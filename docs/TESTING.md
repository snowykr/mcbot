...
# CLI 계약만 빠르게 확인
cd mcbot && go test ./internal/cli/... -run 'TestRuntimeWiringUsesBotRunEntryPoint|TestMakeOperationalTargetsDelegateToCLI|TestDocsDescribeCLIFirstWorkflow'
